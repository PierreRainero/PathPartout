...
class MapHandlerViewController: UIViewController {
    ...
    var runs: [Run] = [
        Run(name: "Tour de St Phillipe", description: "Un petit tour pendant la pause repas. Je rajoute un peut de texte pour voir le saut de ligne.", points: [Point(type: "start", latitude: 43.617911, longitude: 7.074644, name: "MK", description: "Le MK, bar légendaire de Sophia Antipolis."),Point(type: "start", latitude: 43.623187, longitude: 7.076532, name: "Gusto", description: "Restaurant reconnu dans tout Sophia Antipolis."),Point(type: "finish", latitude: 43.620458, longitude: 7.070573, name: "Golf", description: "Espace de détente et de pratique du Golf.")]),
        Run(
            name: "Tournée des bars", description: "Tournée des nombreux bars des alentours.", points: [Point(type: "start", latitude: 43.618673, longitude: 7.0748659, name: "MK", description: "Le MK, bar légendaire de Sophia Antipolis."),Point(type: "", latitude: 43.6177577, longitude: 7.0746102, name: "Green King", description: "Venez boire une pinte au Green King !"),Point(type: "", latitude:  43.6212068, longitude: 7.0639032, name: "L'atelier 67", description: "blabla"),Point(type: "finish", latitude: 43.619034, longitude: 7.0565848, name: "", description: "")]),
        Run(name: "Chasse aux sangliers", description: "Petite session de chasse avec l'ami Bealou.", points: [Point(type: "start", latitude: 43.6176093, longitude: 7.0681092, name: "", description: ""),Point(type: "", latitude: 43.6184054, longitude: 7.0649818, name: "", description: ""),Point(type: "finish", latitude: 43.6197084, longitude: 7.062774, name: "", description: "")])
    ]
